...
__decorate([
    (0, typeorm_1.OneToOne)(() => user_entity_1.User, { onDelete: "CASCADE", onUpdate: "CASCADE" }),
...
__decorate([
    (0, typeorm_1.Column)({ name: "phoneNumber", nullable: true, unique: true }),
    __metadata("design:type", String)
], Profile.prototype, "phone_number", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: "profilePicture", nullable: true }),
    __metadata("design:type", String)
